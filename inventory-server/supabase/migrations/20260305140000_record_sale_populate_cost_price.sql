-- record_sale: populate sale_lines.cost_price from warehouse_products at insert time.
-- Required for accurate COGS and profit in reports (cost at time of sale).
