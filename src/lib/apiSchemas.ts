...
const apiProductItemSchema = z
  .object({
    ...
    barcode: z.union([z.string(), z.null()]).optional().transform((v) => v ?? ''),
    ...
    location: z.union([z.record(z.string(), z.unknown()), z.null()]).optional().transform((v) => v ?? {}),
    supplier: z.union([z.record(z.string(), z.unknown()), z.null()]).optional().transform((v) => v ?? {}),
    images: z.array(z.string()).optional().default([]),
    expiryDate: z.union([z.string(), z.date(), z.number(), z.null()]).optional().nullable(),
    createdAt: z.union([z.string(), z.date(), z.number()]).optional(),
    updatedAt: z.union([z.string(), z.date(), z.number()]).optional(),
    createdBy: z.string().optional().default(''),
    version: z.number().optional(),
    sizeKind: z.enum(['na', 'one_size', 'sized']).optional().catch('na'),
